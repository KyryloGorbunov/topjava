package com.javawebinar.topjava.web;
...
import com.javawebinar.topjava.ActiveDbProfileResolver;
...
public abstract class AbstractControllerTest {
    private static final Locale COM_LOCALE = new Locale("com");
    ...
    private String getMessage(String code) {
        return messageSourceAccessor.getMessage(code, COM_LOCALE);
    }
