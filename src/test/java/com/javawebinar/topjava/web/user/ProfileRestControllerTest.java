package com.javawebinar.topjava.web.user;
...
import com.javawebinar.topjava.service.UserService;
import com.javawebinar.topjava.to.UserTo;
import com.javawebinar.topjava.util.UsersUtil;
import com.javawebinar.topjava.web.AbstractControllerTest;
import com.javawebinar.topjava.web.json.JsonUtil;

import static org.springframework.test.web.servlet.result.MockMvcResultHandlers.print;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.content;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;
import static com.javawebinar.topjava.TestUtil.userHttpBasic;
import static com.javawebinar.topjava.UserTestData.*;
import static com.javawebinar.topjava.util.exception.ErrorType.VALIDATION_ERROR;
import static com.javawebinar.topjava.web.ExceptionInfoHandler.EXCEPTION_DUPLICATE_EMAIL;
import static com.javawebinar.topjava.web.user.ProfileRestController.REST_URL;
...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void update() throws Exception {
        ...
        UserTo updatedTo = new UserTo(null, "newName", "user@gmail.com", "newPassword", 1500);
